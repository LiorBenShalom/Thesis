...
- **Overlap sweep** (≥1/≥2/≥3/exact — ראה METHODOLOGY_BASELINES §M2): גם דרישת התאמה הדוקה יותר לא עוזרת. ≥2 *מחמיר* (drugs 9.09), exact ≈ median (8.50). שני תיקים עם set-סעיפים זהה רחוקים בעונש כמו זוג אקראי → הסעיף לא קובע עונש בשום רמת דיוק.
